...
#  Generated on:      Wed May  8 15:33:42 2019
#  Design:            LCD_CTRL
...
#   clk (period 9.000ns) in timing_config func_mode([lcd_ctrl_APR.sdc])
#   clk (period 9.000ns) in timing_config scan_mode([lcd_ctrl_APR.sdc])
...
set_ccopt_property clock_period -pin clk 9

# Skew group to balance non generated clock:clk in timing_config:func_mode (sdc lcd_ctrl_APR.sdc)
...
# Skew group to balance non generated clock:clk in timing_config:scan_mode (sdc lcd_ctrl_APR.sdc)
